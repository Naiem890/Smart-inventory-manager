...
const Register = () => {
  ...
  return (
    <div className="px-6 xl:px-0">
      <div className="max-w-6xl mx-auto  sm:p-6 lg:p-8  md:mt-2 rounded-xl">
        <div className="grid md:grid-cols-12 ">
          <div className=" mt-4 mx-auto md:mx-0 p-5 max-w-lg rounded-lg col-span-6">
            <img className=" " src={registerImage} alt="" />
          </div>
          <div className="col-span-6 ">
            <div className="p-4 mx-auto md:mx-0 max-w-md ml-auto bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
              {/* =========== */}
              {/* Register Form  */}
              {/* =========== */}
